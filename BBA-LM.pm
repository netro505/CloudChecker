...
//	[scale_out] (lat=-1) & l>0 & (rt>maxRt) & (t+TAU<maxTime)-> 
//	(current_pod'=desired_replica<40?pod+4:pod+pod)&(lat'=l>0?l-1:lat)&(rt'=up_rt)&(util'=u>util? u_util:util)&(t'=t+TAU);
...
//	[scale_out] scalability>0 & scalability<1 : scalability;
//	[scale_in] scalability>0 & scalability<1 : scalability;
//	[do_not] scalability>0 & scalability<1 : scalability;
endrewards

rewards "opt_scalability"
	scalability=1 : scalability;
//	[scale_out] scalability=1 : scalability;
//	[scale_in]  scalability=1 : scalability;
//	[do_not]  scalability=1 : scalability;
endrewards

rewards "high_scalability"
	scalability>=1 & scalability<5: scalability;
//	[scale_out] scalability>1 & scalability<5: scalability;
//	[scale_in] scalability>1 & scalability<5: scalability;
//	[do_not] scalability>1 & scalability<5: scalability;
endrewards
